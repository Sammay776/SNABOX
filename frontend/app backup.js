// Define a reusable config constant for uploads
// (could have just inlined, but better to make it obvious)
...
function switchView(viewId) {
    ...
    // If view exists, show it, otherwise fallback
    if (views[viewId]) {
...
function handleSignup(e) {
    ...
    .then(({ ok, data }) => {
        ...
        showLoginLink.click(); // auto-switch to login
    })
    .catch(err => {
...
// Checks current auth state and updates UI accordingly
